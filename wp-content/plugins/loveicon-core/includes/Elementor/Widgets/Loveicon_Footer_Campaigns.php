...
class Loveicon_Footer_Campaigns extends Widget_Base
{

    public function get_name()
    {
        return 'loveicon_footer_campaigns';
    }

    public function get_title()
    {
        return esc_html__('Loveicon Footer Campaigns', 'loveicon-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Campaigns', 'loveicon-core'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Title', 'loveicon-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Aid for Refugees', 'loveicon-core'),
            ]
        );
