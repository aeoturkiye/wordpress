...
class Loveicon_Footer_Two extends Widget_Base
{

    public function get_name()
    {
        return 'loveicon_footer_two';
    }

    public function get_title()
    {
        return esc_html__('Loveicon Footer Two', 'loveicon-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Recent Appeals', 'loveicon-core'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Title', 'loveicon-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Asia Africa Pacific', 'loveicon-core'),
            ]
        );
