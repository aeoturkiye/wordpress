...
class Service_Sidebar_Menu extends \WP_Widget
{
	...
	public function __construct()
	{
		$widget_ops = array(
			...
			'description'                 => __('Add a Loveicon Services custom menu to your sidebar.'),
			'customize_selective_refresh' => true,
		);
		parent::__construct('Service_Sidebar_Menu', __('Loveicon Service Menu'), $widget_ops);
	}
	...
	public function widget($args, $instance)
	{
		...
		if (!empty($menu_no)) {
			...
			echo '<div class="category-widget-two"><ul class="widget cat-list">';
			...
			foreach ($primaryNav as $navItem) {
				...
				if ($object_post_id == $post_object_id) {
					echo '<li class="current active"><a href="' . $navItem->url . '" title="' . $navItem->title . '">' . $navItem->title . '</a></li>';
				} else {
