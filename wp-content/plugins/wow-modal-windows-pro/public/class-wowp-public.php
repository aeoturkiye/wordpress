...
use ModalWindowPro\Maker\Modal;
use ModalWindowPro\Maker\Script;
use ModalWindowPro\Publish\Conditions;
use ModalWindowPro\Publish\Display;
use ModalWindowPro\Publish\Singleton;
...
class WOWP_Public {
	...
	public function load_assets(): void {
		...
		if ( ! empty( $args ) ) {
			wp_enqueue_script( $handle . '-effects', $assets . 'js/effects' . $this->pefix . '.js', ['jquery'], $version, true );
			wp_enqueue_script( $handle, $assets . 'js/modalWindow' . $this->pefix . '.js', ['jquery', $handle . '-effects'], $version, true );
			$data = [];
