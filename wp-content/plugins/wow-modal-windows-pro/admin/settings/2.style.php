...
?>
    <details class="wpie-item"<?php echo esc_attr( $open ); ?>>
        ...
        <summary class="wpie-item_heading">
            ...
            <span class="wpie-item_heading_label"><?php esc_html_e( 'General', 'wow-modal-windows-pro' ); ?></span>
        ...
        <div class="wpie-item_content">
            ...
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Properties', 'wow-modal-windows-pro' ); ?></div>
            ...
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Border', 'wow-modal-windows-pro' ); ?></div>
                <div class="wpie-fields">
            ...
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Shadow', 'wow-modal-windows-pro' ); ?></div>
                <div class="wpie-fields">
            ...
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Content', 'wow-modal-windows-pro' ); ?></div>
                <div class="wpie-fields">
            ...
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Background', 'wow-modal-windows-pro' ); ?></div>
                <div class="wpie-fields">
					<?php $field->create( 'overlay_color' ); ?>
					<?php $field->create( 'bg_color' ); ?>
					<?php $field->create( 'modal_background_img' ); ?>
                </div>
            </div>
        </div>
    </details>
...
?>
    <details class="wpie-item"<?php echo esc_attr( $open ); ?>>
        ...
        <summary class="wpie-item_heading">
            ...
            <span class="wpie-item_heading_label"><?php esc_html_e( 'Location', 'wow-modal-windows-pro' ); ?></span>
            <span class="wpie-item_heading_type"></span>
            <span class="wpie-item_heading_toogle">
        <span class="wpie-icon wpie_icon-chevron-down"></span>
        <span class="wpie-icon wpie_icon-chevron-up "></span>
...
?>
    <details class="wpie-item"<?php echo esc_attr( $open ); ?>>
        ...
        <summary class="wpie-item_heading">
            ...
            <span class="wpie-item_heading_label"><?php esc_html_e( 'Title', 'wow-modal-windows-pro' ); ?></span>
            <span class="wpie-item_heading_type"></span>
            <span class="wpie-item_heading_toogle">
        <span class="wpie-icon wpie_icon-chevron-down"></span>
        <span class="wpie-icon wpie_icon-chevron-up "></span>
...
?>
    <details class="wpie-item"<?php echo esc_attr( $open ); ?>>
        ...
        <summary class="wpie-item_heading">
            ...
            <span class="wpie-item_heading_label"><?php esc_html_e( 'Close Button', 'wow-modal-windows-pro' ); ?></span>
            <span class="wpie-item_heading_type"></span>
            <span class="wpie-item_heading_toogle">
        <span class="wpie-icon wpie_icon-chevron-down"></span>
        <span class="wpie-icon wpie_icon-chevron-up "></span>
        ...
        <div class="wpie-item_content">
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Positioning', 'wow-modal-windows-pro' ); ?></div>
                <div class="wpie-fields">
            ...
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Type', 'wow-modal-windows-pro' ); ?></div>
                <div class="wpie-fields">
            ...
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Font', 'wow-modal-windows-pro' ); ?></div>
                <div class="wpie-fields">
            ...
            <div class="wpie-fieldset">
                <div class="wpie-legend"><?php esc_html_e( 'Colors', 'wow-modal-windows-pro' ); ?></div>
                <div class="wpie-fields">
...
?>
    <details class="wpie-item"<?php echo esc_attr( $open ); ?>>
        ...
        <summary class="wpie-item_heading">
            ...
            <span class="wpie-item_heading_label"><?php esc_html_e( 'Mobile Rule', 'wow-modal-windows-pro' ); ?></span>
            <span class="wpie-item_heading_type"></span>
            <span class="wpie-item_heading_toogle">
        <span class="wpie-icon wpie_icon-chevron-down"></span>
        <span class="wpie-icon wpie_icon-chevron-up "></span>
