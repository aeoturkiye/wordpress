...
class Settings_Helper {
	...
	public static function animation(): array {
		return [
			...
			'blind:direction:up'         => __( 'Blind Up', 'wow-modal-windows-pro' ),
			'blind:direction:down'       => __( 'Blind Down', 'wow-modal-windows-pro' ),
			'blind:direction:left'       => __( 'Blind Left', 'wow-modal-windows-pro' ),
			'blind:direction:right'      => __( 'Blind Right', 'wow-modal-windows-pro' ),
			'bounce:times:3'             => __( 'Bounce', 'wow-modal-windows-pro' ),
			'clip:direction:vertical'    => __( 'Clip Vertical', 'wow-modal-windows-pro' ),
			'clip:direction:horizontal'  => __( 'Clip Horizontal', 'wow-modal-windows-pro' ),
			'drop:direction:up'          => __( 'Drop Up', 'wow-modal-windows-pro' ),
			'drop:direction:down'        => __( 'Drop Down', 'wow-modal-windows-pro' ),
			'drop:direction:left'        => __( 'Drop Left', 'wow-modal-windows-pro' ),
			'drop:direction:right'       => __( 'Drop Right', 'wow-modal-windows-pro' ),
			'explode:pieces:4'           => __( 'Explode 4 Pieces', 'wow-modal-windows-pro' ),
			'explode:pieces:9'           => __( 'Explode 9 Pieces', 'wow-modal-windows-pro' ),
			'explode:pieces:12'          => __( 'Explode 12 Pieces', 'wow-modal-windows-pro' ),
			'fade'                       => __( 'Fade', 'wow-modal-windows-pro' ),
			'fold:size:5'                => __( 'Fold', 'wow-modal-windows-pro' ),
			'highlight:color:#ffff99'    => __( 'Highlight', 'wow-modal-windows-pro' ),
			'puff:percent:150'           => __( 'Puff', 'wow-modal-windows-pro' ),
			'pulsate:times:5'            => __( 'Pulsate', 'wow-modal-windows-pro' ),
			'scale:direction:both'       => __( 'Scale Both', 'wow-modal-windows-pro' ),
			'scale:direction:vertical'   => __( 'Scale Vertical', 'wow-modal-windows-pro' ),
			'scale:direction:horizontal' => __( 'Scale Horizontal', 'wow-modal-windows-pro' ),
			'shake:direction:left'       => __( 'Shake Left', 'wow-modal-windows-pro' ),
			'shake:direction:up'         => __( 'Shake Up', 'wow-modal-windows-pro' ),
			'slide:direction:left'       => __( 'Slide Left', 'wow-modal-windows-pro' ),
			'slide:direction:right'      => __( 'Slide Right', 'wow-modal-windows-pro' ),
			'slide:direction:up'         => __( 'Slide Up', 'wow-modal-windows-pro' ),
			'slide:direction:down'       => __( 'Slide Down', 'wow-modal-windows-pro' ),
		];
	}
	...
	public static function modals( $id ): array {
		...
		$arr    = [];
		if ( empty( $result ) ) {
			$arr[] = __( 'Not created yet', 'wow-modal-windows-pro' );
		...
		foreach ( $result as $key => $value ) {
			$prev_id    = $value->id;
			$prev_title = ! empty( $value->title ) ? $value->title : __( 'UnTitle', 'wow-modal-windows-pro' );
