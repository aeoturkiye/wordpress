...
class ImporterExporter {
	...
	public static function form_export(): void {
        ...
        <form method="post">
            ...
            <p>
				<?php
				submit_button( __( 'Export All Data', 'wow-modal-windows-pro' ), 'secondary', 'submit', false ); ?><?php
        ...
        <form method="post" enctype="multipart/form-data" action="">
            ...
            <p>
                <label>
					...
					<?php esc_html_e( 'Update item if item already exists.', 'wow-modal-windows-pro' ); ?>
                </label>
            ...
            <p>
				<?php
				submit_button( __( 'Import', 'wow-modal-windows-pro' ), 'secondary', 'submit', false ); ?><?php
	...
	public static function import_data(): void {
        ...
        if ( self::get_file_extension( sanitize_text_field( $_FILES['import_file']['name'] ) ) !== 'json' ) {
			wp_die(
				esc_html__( 'Please upload a valid .json file', 'wow-modal-windows-pro' ),
				esc_html__( 'Error', 'wow-modal-windows-pro' ),
				[ 'response' => 400 ] );
		}
