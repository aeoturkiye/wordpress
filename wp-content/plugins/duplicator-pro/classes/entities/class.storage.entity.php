    ...
    */
    ...
    public function purge_old_local_packages()
    {
        ...
        try {
            ...
            DUP_PRO_Log::infoTrace('MAX PACKAGES: ' .  $this->local_max_files);
            DUP_PRO_Log::infoTrace('OLD PACKAGES LIST ' .  SnapLog::v2str($fileList));
            ...
            for ($i = 0; $i < count($fileList) - $this->local_max_files; $i++) {
                ...
                DUP_PRO_Log::infoTrace('DELETE PACKAGE ' . $nameHash);
