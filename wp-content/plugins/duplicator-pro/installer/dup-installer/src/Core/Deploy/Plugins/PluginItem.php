...
class PluginItem
{
    ...
    public function isActive($subsite = -1)
    {
        if ($this->data['active'] === true) {
            ...
            $this->data['active'] === true || (is_array($this->data['active'])
     ...
     * @param null    $shortMsg     Short message for deactivation log
     * @param null    $longMsg      long message for deactivation log
