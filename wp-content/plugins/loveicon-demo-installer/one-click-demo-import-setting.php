...
add_filter(
	'pt-ocdi/replace_url',
	function () {
		return array( 'https://loveicon.smartdemowp.com/' );
	}
);
...
add_filter(
	...
	function () {
		return '/wp-content/plugins/loveicon-demo-installer/images/';
	}
);
...
add_filter(
	...
	function () {
		return array(
			array(
				'import_file_name'             => esc_html__( 'Loveicon', 'chaoz' ),
				...
				'preview_url'                  => 'https://loveicon.smartdemowp.com/',
				'local_import_redux'           => array(
					array(
						'file_path'   => plugin_dir_path( __FILE__ ) . 'demo-data/demo1/settings.json',
						'option_name' => 'loveicon_options',
					),
				),
			),
		);
...
add_action(
	...
	function () {
		...
		$home_page = get_page_by_title( 'Home Page 01' );
